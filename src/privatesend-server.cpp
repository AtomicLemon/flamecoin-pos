...
void CPrivateSendServer::ProcessMessage(CNode* pfrom, const std::string& strCommand, CDataStream& vRecv, CConnman& connman)
{
    ...
    if (fLiteMode) return; // ignore all Flamecoin related functionality
...
/*
    ...
    allow endless transaction that would bloat Flamecoin and make it unusable. To
...
{
    if (fLiteMode) return;        // disable all Flamecoin specific functionality

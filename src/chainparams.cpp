...
{
    const char* pszTimestamp = "Flamecoin 23/08/2019";
...
public:
    CMainParams() {
        ...
        consensus.nPowTargetTimespan = 24 * 60 * 60; // Flamecoin: 1 day
        consensus.nPowTargetSpacing = 2.5 * 60; // Flamecoin: 2.5 minutes
        ...
        //vSeeds.push_back(CDNSSeedData("flamecoin.org", "dnsseed.flamecoin.org"));
        //vSeeds.push_back(CDNSSeedData("flamecoindot.io", "dnsseed.flamecoindot.io"));
        //vSeeds.push_back(CDNSSeedData("masternode.io", "dnsseed.masternode.io"));

        // Flamecoin addresses start with 'X'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,76);
        // Flamecoin script addresses start with '7'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,16);
        // Flamecoin private keys start with '7' or 'X'
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,204);
        // Flamecoin BIP32 pubkeys start with 'xpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x04)(0x88)(0xB2)(0x1E).convert_to_container<std::vector<unsigned char> >();
        // Flamecoin BIP32 prvkeys start with 'xprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x04)(0x88)(0xAD)(0xE4).convert_to_container<std::vector<unsigned char> >();

        // Flamecoin BIP44 coin type is '5'
        nExtCoinType = 5;
...
public:
    CTestNetParams() {
        ...
        genesis = CreateGenesisBlock(1495303201UL, 55620UL, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x0000013c35770b302a55a25bf6e25068b2c7d80c7a7f18e8ebca098123b3232e"));
        assert(genesis.hashMerkleRoot == uint256S("0x1803b65a08524bb0c6a22ea40d8a7697e37ed6035a716cb8681cd80037d586cf"));
        ...
        //vSeeds.push_back(CDNSSeedData("flamecoindot.io",  "testnet-seed.flamecoindot.io"));
        //vSeeds.push_back(CDNSSeedData("masternode.io", "test.dnsseed.masternode.io"));

        // Testnet Flamecoin addresses start with 'y'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,140);
        // Testnet Flamecoin script addresses start with '8' or '9'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,19);
        // Testnet private keys start with '9' or 'c' (Bitcoin defaults)
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,239);
        // Testnet Flamecoin BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x04)(0x35)(0x87)(0xCF).convert_to_container<std::vector<unsigned char> >();
        // Testnet Flamecoin BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x04)(0x35)(0x83)(0x94).convert_to_container<std::vector<unsigned char> >();

        // Testnet Flamecoin BIP44 coin type is '1' (All coin's testnet default)
        nExtCoinType = 1;
        ...
        checkpointData = (CCheckpointData) {
            boost::assign::map_list_of
            (    0, uint256S("0x0000013c35770b302a55a25bf6e25068b2c7d80c7a7f18e8ebca098123b3232e"))
        };

        chainTxData = ChainTxData{
            1495303201, // * UNIX timestamp of last known number of transactions (Block 96717)
            0,     // * total number of transactions between genesis and that timestamp
                        //   (the tx=... number in the SetBestChain debug.log lines)
            0        // * estimated number of transactions per second after that timestamp
        };
...
public:
    CDevNetParams() {
        ...
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x4e193807efee9f6da337bd2715ce8d686e0de5efa88b7a51df04db4dfde61429"));
        assert(genesis.hashMerkleRoot == uint256S("0x1803b65a08524bb0c6a22ea40d8a7697e37ed6035a716cb8681cd80037d586cf"));
        ...
        vFixedSeeds.clear();
        vSeeds.clear();
        //vSeeds.push_back(CDNSSeedData("flamecoinevo.org",  "devnet-seed.flamecoinevo.org"));
        ...
        checkpointData = (CCheckpointData) {
            boost::assign::map_list_of
            (      0, uint256S("0x4e193807efee9f6da337bd2715ce8d686e0de5efa88b7a51df04db4dfde61429"))
        };
...
public:
    CRegTestParams() {
        ...
        genesis = CreateGenesisBlock(1495303202, 0, 0x207fffff, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x61b27774780fb5784f3057cb3ef413b7890e61127a0e2681e4ff0c636a871bcf"));
        assert(genesis.hashMerkleRoot == uint256S("0x1803b65a08524bb0c6a22ea40d8a7697e37ed6035a716cb8681cd80037d586cf"));
        ...
        checkpointData = (CCheckpointData){
            boost::assign::map_list_of
            ( 0, uint256S("61b27774780fb5784f3057cb3ef413b7890e61127a0e2681e4ff0c636a871bcf"))
        };
        ...
        // Regtest Flamecoin addresses start with 'y'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,140);
        // Regtest Flamecoin script addresses start with '8' or '9'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,19);
        // Regtest private keys start with '9' or 'c' (Bitcoin defaults)
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,239);
        // Regtest Flamecoin BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x04)(0x35)(0x87)(0xCF).convert_to_container<std::vector<unsigned char> >();
        // Regtest Flamecoin BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x04)(0x35)(0x83)(0x94).convert_to_container<std::vector<unsigned char> >();

        // Regtest Flamecoin BIP44 coin type is '1' (All coin's testnet default)
        nExtCoinType = 1;

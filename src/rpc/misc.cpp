...
UniValue getinfo(const JSONRPCRequest& request)
{
    if (request.fHelp || request.params.size() != 0)
        throw std::runtime_error(
            ...
            "  \"privatesend_balance\": xxxxxx, (numeric) the anonymized flamecoin balance of the wallet\n"
...
UniValue debug(const JSONRPCRequest& request)
{
    if (request.fHelp || request.params.size() != 1)
        throw std::runtime_error(
            ...
            "                       mempoolrej, net, proxy, prune, qt, rand, reindex, rpc, selectcoins, tor, zmq, flamecoin\n"
            ...
            "\nExamples:\n"
            + HelpExampleCli("debug", "flamecoin")
            + HelpExampleRpc("debug", "flamecoin+net")
        );
...
#ifdef ENABLE_WALLET
        // Case 1: Flamecoin address and we have full public key:
...
{ //  category              name                      actor (function)         okSafeMode
  //  --------------------- ------------------------  -----------------------  ----------
    ...
    /* Flamecoin features */
    { "flamecoin",               "mnsync",                 &mnsync,                 true,  {} },
    { "flamecoin",               "spork",                  &spork,                  true,  {"value"} },

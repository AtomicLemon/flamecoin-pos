...
void masternode_list_help()
{
    throw std::runtime_error(
            ...
            "  owneraddress   - Print the masternode owner Flamecoin address\n"
            "  payee          - Print the masternode payout Flamecoin address (can be additionally filtered,\n"
            "                   partial match)\n"
            "  pubKeyOperator - Print the masternode operator public key\n"
            "  status         - Print masternode status: ENABLED / POSE_BANNED\n"
            "                   (can be additionally filtered, partial match)\n"
            "  votingaddress  - Print the masternode voting Flamecoin address\n"
        );
}
...
{ //  category              name                      actor (function)         okSafe argNames
  //  --------------------- ------------------------  -----------------------  ------ ----------
    { "flamecoin",               "masternode",             &masternode,             true,  {} },
    { "flamecoin",               "masternodelist",         &masternodelist,         true,  {} },
    { "flamecoin",               "getpoolinfo",            &getpoolinfo,            true,  {} },
#ifdef ENABLE_WALLET
    { "flamecoin",               "privatesend",            &privatesend,            false, {} },
#endif // ENABLE_WALLET
};

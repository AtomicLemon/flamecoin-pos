...
void BitcoinGUI::createActions()
{
    ...
    aboutAction->setStatusTip(tr("Show information about Flamecoin Core"));
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (clientModel->getNetworkActive()) {
        labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Flamecoin network", "", count));
    } else {
...
{
    QString strTitle = tr("Flamecoin Core"); // default title
    ...
    // Append title to "Flamecoin Core - "
    if (!msgType.isEmpty())
        strTitle += " - " + msgType;

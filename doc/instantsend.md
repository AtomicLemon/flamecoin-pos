...
This mechanism has been integrated into Bitcore-Node-Flamecoin which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/flamecoin/insight-api-flamecoin#web-socket-api](https://github.com/flamecoin/insight-api-flamecoin#web-socket-api)
* API: [https://github.com/flamecoin/insight-api-flamecoin#instantsend-transactions](https://github.com/flamecoin/insight-api-flamecoin#instantsend-transactions)

...
Clone the git repositories for Flamecoin Core and Gitian.
...
in the Flamecoin Core repository under 'Fetch and create inputs' to install sources which require
...
Gitian builds' in [doc/release-process.md](release-process.md#perform-gitian-builds) in the Flamecoin Core repository.
...
For example:
```bash
URL=https://github.com/crowning-/flamecoin.git
...
[flamecoin/gitian.sigs](https://github.com/flamecoin/gitian.sigs/) repository, or if that's not possible to create a pull
request.
